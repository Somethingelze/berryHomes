...
public class ContactController {
    ...
    @PostMapping("/send")
    public ContactDto sendContactByEmail(@Valid @RequestBody ContactDto contactDto) {
        return contactService.sendContactByEmail(contactDto);
    }

    @DeleteMapping("/delete/{id}")
    public void deleteContact(@Valid UUID id) {
